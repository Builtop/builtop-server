...
export const completeCorporateBuyerInfoSchema = yup.object().shape({
...
export type completeCorporateBuyerInfoInput = yup.InferType<typeof completeCorporateBuyerInfoSchema>;