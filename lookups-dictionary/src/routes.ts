...
import {
  createCityHandler,
  deleteCityHandler,
  findAllCitiesHandler,
  findAndUpdateCityHandler,
  findCityByIdHandler,
...
router.post(
  "/api/country",
  json(),
  validateSchema(addCountrySchema),
  createCountryHandler
);
...
router.get("/api/city/:id", findCityByIdHandler);
router.post(
  "/api/city/:countryId",
  json(),
  validateSchema(addCitySchema),
  createCityHandler
);
router.put("/api/city/:id", json(), findAndUpdateCityHandler);
router.delete("/api/city/:id", deleteCityHandler);
